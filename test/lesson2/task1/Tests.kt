...
class Tests {
    ...
    fun myFun() {
        assertEquals(
            setOf("Удалов Александр", "Иванов Даня"),
            myFun(
                listOf(
                    "Удалов Александр: улица Подьяческая, 10, кв. 2",
                    "Иванов Даня: улица Подьяческая, 10, кв. 5", "Петров Николай: улица Ленина, 18, кв. 6"
                ), "улица Подьяческая", 10
            )
        )
    }
}
